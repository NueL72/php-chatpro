...
if (isset($_POST['Add'])) {
    ...
    $sql = "UPDATE `chatbot` SET `queries`='".$queries."',`replies`='".$replies."',`admin_id`='".$adm_id."' WHERE `id`=" . $_GET['id'] . "; ";
...
if (!empty($_GET['id'])) {
    $sql = "SELECT * FROM `chatbot` WHERE `id`=" . $_GET['id'] . ";";
    $query = mysqli_query($conn, $sql);
                                ...
                                <form method="POST" action="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="adm_id"
                                    ...
                                    <div class="input-group float-left" style="padding-top: 10px; padding-left:20px;">
                                        <input type="submit" name="Add" class="btn btn-outline-success" value="Update">
